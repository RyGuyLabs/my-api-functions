...
export async function handler(event, context) {
  ...
  const promptMap = {
    lead_idea: ({name, company, purpose}) =>
      ...
      Make it memorable, confident, punchy, and motivational. Integrate the purpose of contact: "${purpose}" naturally into the messaging.
      Write in a personable and exemplary tone, as if this is a premium communication that will inspire trust and excitement.`,

    nurturing_note: ({name, company, purpose}) =>
      `You are an elite business communicator and copywriter. Write a highly professional, warm, and memorable nurturing note for ${name} at ${company}.
      Ensure it feels personally tailored, persuasive, confident, and inspiring. Integrate the purpose of contact: "${purpose}" naturally.
      The note should be motivational, resonate deeply, and leave a lasting positive impression.`
  };
